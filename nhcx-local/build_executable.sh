#!/bin/bash
# ============================================================================
# build_executable.sh -- Build a single-file executable for nhcx-extract
#
...
echo "============================================"
echo "  Building nhcx-extract executable"
...
# Install nhcx-local and all its dependencies
...
EXECUTABLE="${SCRIPT_DIR}/dist/nhcx-extract"
...
if [ -f "${EXECUTABLE}" ]; then
    ...
    echo "    ${EXECUTABLE} check -m gemma4:26b"
    echo ""
else
    echo ""
